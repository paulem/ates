...
public class AccountingDbContext : DbContext, IUnitOfWork
{
    private readonly IPublisher _publisher;
    
    public AccountingDbContext (DbContextOptions<AccountingDbContext> options, IPublisher publisher) : base(options)
    {
